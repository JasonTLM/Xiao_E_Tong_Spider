...
url = "https://fenxiao.xiaoe-tech.com/pc/distribute_content?id=p_5b3dcdee3d2a5_W14nOcaA&content_app_id=appNpA3AQHk1411"
...
json_srt = response.content.decode('utf-8')
x = json.loads(json_srt)
data = x["data"]
print(data)
